...
\input{quadrotor_math_model/euler_quaternion}
\input{quadrotor_math_model/quadrotor_model}
\input{quadrotor_math_model/motor_model}
...
\input{quadrotor_math_model/lqr}

\clearpage
\section{Hector Quadrotor ROS Stack}
\input{hector_quadrotor/hector_quadrotor}


\chapter{Simulation}

\input{simulation/matlab}
\input{simulation/lqr}
\input{simulation/combine}
\input{simulation/rviz_gazebo}
